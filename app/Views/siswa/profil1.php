                            ...
                            <form action="<?= base_url('admin/users/simpanProfil') ?>" method="post" enctype="multipart/form-data" id="formProfil">
                                ...
                                <div class="col-12">
                                    <?php if (session()->get('role_id') == 7): ?>
                                        <hr>
                                        <h5 class="text-primary mb-3">Data Kelompok</h5>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Batalyon</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" value="<?= $user['nama_batalyon'] ?? '-' ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Kompi / Danki</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" value="<?= $user['nama_kompi'] ?? '-' ?>" readonly>
                                            </div>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" value="Danki: <?= $user['nama_danki'] ?? '-' ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Pleton / Danton</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" value="<?= $user['nama_pleton'] ?? '-' ?>" readonly>
                                            </div>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" value="Danton: <?= $user['nama_danton'] ?? '-' ?>" readonly>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
