...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fas fa-cubes text-primary mr-2"></i>Kelola Bank Soal (C1 - C6)</h1>
                </div>
                <div class="col-sm-6">
...
<script>
    ...
    $(document).ready(function() {
        // --- OTOMATIS KIRIM TOKEN CSRF LEWAT HEADER DARI META TAG ---
        $.ajaxSetup({
            beforeSend: function(xhr, settings) {
                if (settings.type && settings.type.toUpperCase() !== 'GET') {
                    ...
                    // Kirim lewat Header HTTP agar dibaca otomatis oleh CI4
                    xhr.setRequestHeader(csrfHeaderName, csrfHash);

                    // Sertakan juga di dalam body data (jika diperlukan oleh form serialize)
    ...
    // Fungsi helper untuk memperbarui token CSRF di Meta Tag dan Hidden Input secara bersamaan
    ...
    function loadTableSoal() {
        $.ajax({
            url: `${baseUrl}/${rolePrefix}/obe/bank-soal/get/${activeLevel}`,
            type: 'GET',
            dataType: 'json',
            ...
            tbody.append(`
                <tr>
                    <td colspan="4" class="text-center text-muted py-4">
                        Belum ada data soal untuk ${activeLevel}. Silakan isi form di atas.
                    </td>
                </tr>
            `);
            return;
    ...
    function simpanSoal() {
        ...
        // Ambil data secara manual agar token CSRF pasti ikut terkirim dengan benar
        const csrfName = $('#csrf_token_field').attr('name') || '<?= csrf_token() ?>';
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Kesalahan Server / 403',
                    text: 'Periksa kembali console log browser.',
                    confirmButtonColor: '#d33'
                });
            }
        });
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Gagal!',
                            text: 'Gagal menghapus data atau token kedaluwarsa.',
                            confirmButtonColor: '#d33'
                        }).then(() => {
                            location.reload();
                        });
