        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= base_url($prefix . '/sosiometri'); ?>" class="btn btn-sm btn-secondary">
                        <i class="fas fa-arrow-left"></i> Kembali
                    </a>
                </div>

                <div class="card-body">
                    <div id="pdf-viewer-wrapper" style="position: relative; min-height: 500px; background: #eee; border: 1px solid #ccc;">
