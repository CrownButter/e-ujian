...
<body>
    ...
    <table class="main-table">
        ...
        <tbody>
            <?php
            $no = 1;
            // Jika data kosong, tampilkan baris kosong atau informasi bahwa data tidak tersedia
            if (empty($data_list)):
            ?>
                <tr>
                ...
                ?>
                    <tr>
                        ...
                        <?php
                        // Ambil nilai aspek dari database/controller, jika belum ada set default kosong atau 0
                        $nilai_aspek = $row['nilai'] ?? array_fill(0, 22, '');
